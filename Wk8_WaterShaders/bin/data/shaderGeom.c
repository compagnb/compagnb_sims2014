...
//add this feature for using geometry shaders
#extension GL_EXT_geometry_shader4 : enable //enable feature

uniform float time; //pass the time variable in seconds
uniform sampler2DRect texture; //pass the texture

//simple noise function - see end of file
float snoise(vec4 v);
